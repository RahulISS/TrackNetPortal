...
console.log(mergedArray);
      ...
      $scope.SavePoppupFormData = function () {
        ...
        /** disable starts*/
        if( $scope.enableBtn ) {
          if( 'alt1' in $scope.disableAlertArray && 'alarmFirstCheck' in $scope.pointSettingData ) { console.log("1 disable");
            if($scope.pointSettingData.alarmFirstCheck === 0) {
          ...
          if( 'alt2' in $scope.disableAlertArray && 'alarmSecondCheck' in $scope.pointSettingData ) {console.log("2 disable");
            if($scope.pointSettingData.alarmSecondCheck === 0) {
          ...
          if( 'alt3' in $scope.disableAlertArray && 'alarmThirdCheck' in $scope.pointSettingData ) {console.log("3 disable");
            if($scope.pointSettingData.alarmThirdCheck === 0) {
        ...
        if( $scope.deleteBtn )
        {
          if ( 'al1' in $scope.deleteAlertArray && $scope.deleteAlertArray.al1 === true) { console.log("in 1");
            $scope.alert1 = null;
            $scope.alarmFirstCheck = null;
          }

          if ( 'al2' in $scope.deleteAlertArray && $scope.deleteAlertArray.al2 === true ) {console.log("in 2");
            $scope.alert2 = null;
            $scope.alarmSecondCheck = null;
          }

          if ( 'al3' in $scope.deleteAlertArray && $scope.deleteAlertArray.al3 === true ) {console.log("in 3");
            $scope.alert3 = null;
            $scope.alarmThirdCheck = null;
          }
        }
